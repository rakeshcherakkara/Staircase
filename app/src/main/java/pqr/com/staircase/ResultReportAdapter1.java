...
public class ResultReportAdapter1 extends ArrayAdapter {


    private List list = new ArrayList();

    public ResultReportAdapter1(@NonNull Context context, int resource) {

        super(context, resource);
    }


    public void add(ResultReportDataProvider1 object) {
        super.add(object);
        list.add(object);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            row = inflater.inflate(R.layout.result_reportlist1,parent,false);
        ...
        ResultReportDataProvider1 resultReportDataProvider = (ResultReportDataProvider1)this.getItem(position);
