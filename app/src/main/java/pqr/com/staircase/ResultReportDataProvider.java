...
/**
 * Created by ibm on 11/04/2018.
 */

public class ResultReportDataProvider
{

    private String serialNum,resultDate,productName,priceName,priceValue,priceNumber;

    public ResultReportDataProvider(String serialNum,String resultDate,String productName,String priceName,String priceValue,String priceNumber)
    {
